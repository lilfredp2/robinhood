...
# then open http://localhost:8000/ledger/
```

## Deploy

It is a static site, so anything that serves files will do. Published from the
repository root it lives at `/ledger/`; see the root `README.md` for the Pages
setup.
